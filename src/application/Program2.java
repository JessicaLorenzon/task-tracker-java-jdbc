	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case "marcar concluida":
				...
				if (tarefaDao.encontrarPorId(idConcluido) == null) {
					System.out.println("ID não encontrado. Tente novamente!");
				} else {
					Tarefa tarefa = tarefaDao.encontrarPorId(idConcluido);
					tarefa.setStatus(TarefaStatus.CONCLUIDA);
					tarefaDao.atualizar(tarefa);
					System.out.println("Status da tarefa com ID: " + idConcluido + " atualizado com sucesso!");
				}
				System.out.println();
				break;
			case "5":
			case "marcar em progresso":
				...
				if (tarefaDao.encontrarPorId(idAndamento) == null) {
					System.out.println("ID não encontrado. Tente novamente!");
				} else {
					Tarefa tarefa = tarefaDao.encontrarPorId(idAndamento);
					tarefa.setStatus(TarefaStatus.EM_PROGRESSO);
					tarefaDao.atualizar(tarefa);
					System.out.println("Status da tarefa com ID: " + idAndamento + " atualizado com progresso!");
				}
				System.out.println();
				break;
			case "6":
